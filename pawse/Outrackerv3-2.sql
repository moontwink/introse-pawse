...
INSERT INTO `beneficiary` VALUES ('CWTS-C1','7163944','Pasig City'),('CWTS-C2','8762712','2501, Taft Avenue'),('MRF','7617281','Parang Village, Caloocan City'),('Pangarap','7760304','Caloocan City'),('ROTC-R1','6542617','2501, Taft Avenue, Malate, Manilla');
...
CREATE TABLE `feedback` (
  ...
  CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`Beneficiary`) REFERENCES `beneficiary` (`BeneficiaryName`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `feedback` VALUES (100001,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut fermentum metus ac libero aliquam ullamcorper dapibus mi molestie.','MRF','Earlniel Robles'),(100002,'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vivamus nec nisl urna, a consectetur enim.','CWTS-C1','Paulo Melendez'),(100003,'Donec blandit mi sed urna ullamcorper ornare gravida lacus dapibus. Aenean dui sapien, dignissim nec faucibus at, pellentesque vel risus.','MRF','boom'),(100005,'Cras aliquet tellus vitae quam facilisis posuere. Morbi erat magna, posuere ac hendrerit non, sollicitudin aliquet metus. Ut id eleifend turpis.','CWTS-C2','Nancy Naval'),(100006,'Aliquam varius egestas nibh sit amet tincidunt. Fusce ac magna et nisl aliquet fermentum. Vestibulum ante ipsum','Pangarap','Nancy Naval'),(100007,'Aliquam varius egestas nibh sit amet tincidunt. Fusce ac magna et nisl aliquet fermentum. Vestibulum ante ipsum','Pangarap','Nancy Naval'),(100008,'Required for those taking CWTS-C1','CWTS-C1','COSCA');
...
INSERT INTO `csoa_form` VALUES (10000,'Environmental Related','2013-03-15','Moomedia','YMGS','2013-04-10','Pangarap',2500,'Mike Chan','09156271234','Nancy Naval','Junior Officer - Projects and Activities','09178670304','chykuri@gmail.com','Lorem ipsum dolor sit amet, consectetur adipiscing elit.','Nulla cursus pulvinar tortor, nec pretium tellus venenatis non','Pending','','','09:00','15:00'),(10002,'Education for Youth','2013-03-08','La Salle Computer Society','Tutorial for C','2013-03-15','CWTS-C2',150,'Angelo Reyes','09176281812','Earlniel Robles','VP - Projects and Activities','09157828123','reinfield_24@yahoo.com','Praesent aliquet sapien et nunc pharetra pretium','Donec congue augue eu turpis mollis vitae consequat mi facilisis','Approved','Nancy Naval','','10:00','15:30'),(10003,'Resource Mobilization','2013-04-01','Moomedia','dffdfd','2013-05-10','CWTS-C1',500,'sddsds','3434','fdf','fdfddff','3434','ffdfaa233@yahoo.com','dsfdf','sfsfsf','Rejected','Earlniel Robles','invalid form','09:00','12:00'),(10004,'Advocacy Work','2013-04-03','Junior Philippine Institution of Accountancy','Accounting Future','2013-04-12','CWTS-C2',5000,'Christian Irawa','09178283741','Miggy Tanedo','VP-Finance','09178284642','miggy@gmail.com','Vestibulum et commodo nibh. Sed fermentum, dolor in suscipit dapibus','Vestibulum et commodo nibh. Sed fermentum, dolor in suscipit dapibus','Pending',NULL,NULL,'11:00','17:00');
...
INSERT INTO `studentorganization` VALUES ('Junior Philippine Institution of Accountancy','jpia','jpia123'),('La Salle Computer Society','lscs','lscs321'),('Moomedia','moomedia','moo123'),('Nihon Kenkyuu Kai','nkk','nkk123'),('Outdoor Club','outdoor','out123');
...
-- Dump completed on 2013-04-03 13:48:52
